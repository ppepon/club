"""
Django settings for ClubFutbol project.
...
SECRET_KEY = 'nf_oe7gek(q&8!a(qxq_c04phb7cup1@4fif^il8vs*x-hugc)'
...
WSGI_APPLICATION = 'ClubFutbol.wsgi.application'
